...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.5.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-KyZXEAg3QhqLMpG8r+JihlAOuhc/zML+8755GvYr1/SKBCFs3JSh8CCWhbOiVme" crossorigin="anonymous">
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.5.0/dist/js/bootstrap.min.js" integrity="sha384-VI5a3rZjVZ6D6/Df5/6OflI5lMx+ogb6f5umf5Mw5O5/SfE1ahH/II5f5fa2j5x5p" crossorigin="anonymous"></script>
...
<body class="bg-blue-500 ">
  ...
  <div class="absolute top-4 right-4 text-white font-semibold text-xl flex items-center">
    <span class="material-icons mr-2">timer</span>
    <div class="timer_sec" id="timer" style="width: 95px;">60:00</div>
  </div>
        ...
        <div class="flex-grow overflow-y-scroll">
          ...
          <ul class="relative px-1">
             ...
             <li class="relative" id="sidenavSecEx2">
              <!-- Add the data-toggle and data-target attributes to enable collapse -->
              <a class="flex items-center text-md py-6 mt-3 px-6 h-12 bg-gray-300 bg-opacity-50 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-gray-300 transition duration-300 ease-in-out cursor-pointer" data-toggle="collapse" data-target="#collapseSidenavSecEx2">
              ...
              <!-- <ul class="relative accordion-collapse collapse" id="collapseSidenavSecEx2">
                <li class="relative">
                  <a href="#!" class="flex items-center text-md py-6 pl-12 pr-6 h-6 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="primary">Question 1</a>
                </li>
                <li class="relative">
                  <a href="#!" class="flex items-center text-md py-6 pl-12 pr-6 h-6 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="primary">Question 2</a>
                </li>
              </ul> -->
              <div class="collapse" id="collapseSidenavSecEx2">
                <!-- Add your divs containing values from 1 to 5 here -->
                <div>1</div>
                <div>2</div>
                <div>3</div>
                <div>4</div>
  ...
  <script>
    ...
    function startTimer(duration, display) {
      ...
      setInterval(function() {
        ...
        if (--timer < 0) {
          // When the timer reaches 00:00, redirect to result.html
    ...
    window.onload = function() {
      var fiveMinutes = 60 * 60; // 60 minutes
      var display = document.querySelector(".timer_sec");
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      reasoningToggle.addEventListener("click", function() {
        // Toggle the collapse state when the "Reasoning" span is clicked
        var collapseTarget = document.getElementById("collapseSidenavSecEx2");
