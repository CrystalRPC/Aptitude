  ...
  <div class="quiz_box activePractice">
    ...
    <footer>
      <div>
        ...
        &nbsp;
        <button class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow" id="theory-btn" onclick="window.open('Categories/dashboard')">Learn Theory</button>
