            ...
            <div class="flex-grow overflow-y-scroll">
                ...
                <div class="p-4">
                    <ul class="space-y-1">
                        ...
                        <li>
                            <a href="javascript:void(0)" onclick="location.href='Test/testRules'"
                                class="flex items-center bg-white hover:bg-yellow-50 rounded-xl font-bold text-lg  text-gray-900 py-3 px-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                    class="text-lg mr-4" viewBox="0 0 16 16">
                                    <path
        ...
        <div class="w-24 bg-gray-300 h-6 rounded-md ">
                    ...
                    <div class="col-span-2 flex">
                        ...
                        <div class="p-4 bg-blue-100 rounded-xl flex justify-between items-center w-full">
                            ...
                            <div class="">
                                <button type="button"
                                    class="inline-flex items-center justify-center py-2 px-3 rounded-xl bg-white text-gray-800 hover:text-green-500 text-sm font-semibold transition" onclick="window.open('Categories/Practice')" target="_blank">
                                    Start Practicing
                                </button>
                            </div>
                        </div>
